...
export class StudentCompanyContractMapper {
  ...
  async toStudentCompanyContractResponseDto(
    contract: StudentCompanyContract,
    ...
    return {
      ...
      student: this.studentMapper.toStudentBasicInfoResponseDto(
        contract.student as unknown as Student,
      ),
      company: this.companyMapper.toCompanyBasicInfoResponseDto(
        contract.company as unknown as Company,
      ),
