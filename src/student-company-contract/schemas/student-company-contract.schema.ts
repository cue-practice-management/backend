...
export class StudentCompanyContract extends BaseSchema {
  ...
  @Prop({
    required: true,
    enum: StudentCompanyContractStatus,
    default: StudentCompanyContractStatus.PENDING_SIGNATURE,
  })
...
export type StudentCompanyContractDocument =
  SoftDeletableDocument<StudentCompanyContract>;

export const StudentCompanyContractSchema = SchemaFactory.createForClass(
