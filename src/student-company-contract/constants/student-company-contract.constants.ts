...
export const STUDENT_COMPANY_CONTRACT_EXCEPTIONS = {
    ...
    STUDENT_COMPANY_CONTRACT_MISSING: {
        ...
        message: 'Student company contract is missing, and is required for active contracts',
        status: HttpStatus.BAD_REQUEST
    },
    ...
    STUDENT_COMPANY_CONTRACT_CAN_NOT_BE_ACTIVATED: {
        ...
        message: 'Student company contract can not be activated, its status is not pending',
        status: HttpStatus.BAD_REQUEST
    },
}
...
export const STUDENT_COMPANY_CONTRACT_SORT_OPTIONS = ["student", "company", "startDate", "endDate", "status", "createdAt"];
