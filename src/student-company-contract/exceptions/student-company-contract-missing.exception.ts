...
export class StudentCompanyContractMissingException extends BaseHttpException {
    constructor(){
        super(
            ...
            STUDENT_COMPANY_CONTRACT_EXCEPTIONS.STUDENT_COMPANY_CONTRACT_MISSING.message,
            STUDENT_COMPANY_CONTRACT_EXCEPTIONS.STUDENT_COMPANY_CONTRACT_MISSING.status
        )
    }
}