...
export class StudentCompanyContractCanNotBeActivatedException extends BaseHttpException {
    ...
    constructor() {
        super(
            STUDENT_COMPANY_CONTRACT_EXCEPTIONS.STUDENT_COMPANY_CONTRACT_CAN_NOT_BE_ACTIVATED.code,
            STUDENT_COMPANY_CONTRACT_EXCEPTIONS.STUDENT_COMPANY_CONTRACT_CAN_NOT_BE_ACTIVATED.message,
            STUDENT_COMPANY_CONTRACT_EXCEPTIONS.STUDENT_COMPANY_CONTRACT_CAN_NOT_BE_ACTIVATED.status 
        );
    }
}