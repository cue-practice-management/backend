...
export class FacultyMapper {
  ...
  toFacultyResponsePaginatedDto(
    paginatedResult: PaginateResult<FacultyDocument>,
  ): PaginatedResult<FacultyCreatedResponseDto> {
    return {
      docs: paginatedResult.docs.map((faculty) =>
        this.toFacultyResponseDto(faculty),
      ),
