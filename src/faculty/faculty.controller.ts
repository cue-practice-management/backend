...
export class FacultyController {
  ...
  async createFaculty(
    @Body() createFacultyRequestDto: CreateFacultyRequestDto,
  ) {
  ...
  async getFacultyById(
    @Param('facultyId', ParseObjectIdPipe) facultyId: string,
  ) {
  ...
  async updateFaculty(
    @Param('facultyId', ParseObjectIdPipe) facultyId: string,
    @Body() updateFacultyRequestDto: UpdateFacultyRequestDto,
  ) {
    return await this.facultyService.updateFaculty(
      facultyId,
