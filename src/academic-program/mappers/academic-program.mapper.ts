...
export class AcademicProgramMapper {
    ...
    toAcademicProgramResponsePaginatedDto(academicPrograms: PaginateResult<AcademicProgram>): PaginatedResult<AcademicProgramResponseDto> {
        return {
            ...
            docs: academicPrograms.docs.map(academicProgram => this.toAcademicProgramResponseDto(academicProgram)),
        };
