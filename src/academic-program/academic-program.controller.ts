...
export class AcademicProgramController {
  ...
  async createAcademicProgram(
    @Body() createAcademicProgramDto: CreateAcademicProgramRequestDto,
  ) {
    return await this.academicProgramService.createAcademicProgram(
  ...
  async getAcademicPrograms(@Query() filter: AcademicProgramFilterDto) {
    return await this.academicProgramService.getAcademicProgramsByCriteria(
      filter,
    );
  }
  ...
  async updateAcademicProgram(
    @Param('academicProgramId', ParseObjectIdPipe) academicProgramId: string,
    @Body() updateAcademicProgramDto: CreateAcademicProgramRequestDto,
  ) {
    return await this.academicProgramService.updateAcademicProgram(
      academicProgramId,
