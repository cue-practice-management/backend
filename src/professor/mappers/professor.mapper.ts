...
export class ProfessorMapper {
    ...
    toProfessorResponseDto(professor: Professor): ProfessorResponseDto {
        return {
            ...
            academicProgram: this.academicProgramMapper.toAcademicProgramResponseDto(professor.academicProgram as unknown as AcademicProgram),
            createdAt: professor.createdAt,
            updatedAt: professor.updatedAt,
        }
    }

    toProfessorPaginatedResponseDto(paginatedProfessors: PaginateResult<Professor>): PaginatedResult<ProfessorResponseDto> {
        return {
