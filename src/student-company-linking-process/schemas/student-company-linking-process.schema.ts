...
export class StudentCompanyLinkingProcess extends BaseSchema {
    ...
    @Prop({ enum: StudentCompanyLinkingProcessStatus, default: StudentCompanyLinkingProcessStatus.PENDING })
...
export type StudentCompanyLinkingProcessDocument = SoftDeletableDocument<StudentCompanyLinkingProcess>;

export const StudentCompanyLinkingProcessSchema = SchemaFactory.createForClass(StudentCompanyLinkingProcess);
