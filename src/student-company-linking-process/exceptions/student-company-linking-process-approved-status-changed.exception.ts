...
export class StudentCompanyLinkingProcessApprovedStatusChangedException extends BaseHttpException {
    constructor() {
        super(
            STUDENT_COMPANY_LINKING_PROCESS_EXCEPTIONS.APPROVED_STATUS_ALREADY_CHANGED.code,
            STUDENT_COMPANY_LINKING_PROCESS_EXCEPTIONS.APPROVED_STATUS_ALREADY_CHANGED.message,
            STUDENT_COMPANY_LINKING_PROCESS_EXCEPTIONS.APPROVED_STATUS_ALREADY_CHANGED.statusCode
        );
    }
}