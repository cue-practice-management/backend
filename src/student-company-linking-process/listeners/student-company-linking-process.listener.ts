...
export class StudentCompanyLinkingProcessListener {
  ...
  async handleStudentCompanyLinkingProcessCreatedEvent(
    event: StudentCompanyLinkingProcessCreatedEvent,
  ): Promise<void> {
  ...
  async handleStudentCompanyLinkingProcessAcceptedEvent(
