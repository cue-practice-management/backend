...
export class StudentCompanyLinkingProcessMapper {
  ...
  toResponseDto(
    entity: StudentCompanyLinkingProcess,
  ): StudentCompanyLinkingProcessResponseDto {
    return {
      _id: entity._id.toString(),
      student: this.studentMapper.toStudentResponseDto(
        entity.student as unknown as Student,
      ),
  ...
  toPaginatedResponseDto(
    entities: PaginateResult<StudentCompanyLinkingProcess>,
  ): PaginatedResult<StudentCompanyLinkingProcessResponseDto> {
    return {
